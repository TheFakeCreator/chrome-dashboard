...
### Styling Guidelines
- **TAILWIND ONLY**: Always use Tailwind CSS utility classes for ALL styling
- **NO Custom CSS**: Do not create custom CSS classes or stylesheets
- **NO Inline Styles**: Avoid inline style attributes unless absolutely necessary
- **Responsive Design**: Use Tailwind's responsive prefixes (sm:, md:, lg:, xl:, 2xl:)
- **Dark Mode**: Use theme colors defined in tailwind.config.js (dark-bg-primary, dark-text, etc.)
- **Animations**: Use Tailwind's animation utilities (animate-fadeIn, animate-slideUp, etc.)
- **Consistency**: Follow existing Tailwind patterns in the codebase
